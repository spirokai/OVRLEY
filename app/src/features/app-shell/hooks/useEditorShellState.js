 ...
 *
 * @returns {{
 *   activeKeyboardWorkspace: string,
 ...
 *   resetZoom: Function,
 *   setActiveKeyboardWorkspace: Function,
...
export default function useEditorShellState() {
  ...
  const [activeKeyboardWorkspace, setActiveKeyboardWorkspace] = useState('editor')
