...
fn g_force_converts_to_mps2() {
    let (value, unit) = format_parts(
        ...
        "g_force",
        Some(1.0),
        &[("display_unit", r#""mps2""#), ("decimals", "1")],
    );
    assert_eq!(value, "9.8");
...
fn vertical_speed_converts_to_ftmin() {
    let (value, unit) = format_parts(
        ...
        "vertical_speed",
        Some(1.0),
        &[("display_unit", r#""ftmin""#), ("decimals", "1")],
    );
